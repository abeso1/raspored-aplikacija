...
class PdfView extends StatelessWidget {
  const PdfView({
    required this.rasporedType,
    required this.najraniji,
    required this.najkasniji,
    required this.selectedGrupa,
    required this.selectedNastavnik,
    required this.selectedUcionica,
    required this.mappedByUcionica,
    required this.mappedByNastavnici,
    required this.mappedByGrupe,
    required this.grupeMapped,
    required this.predmetiMapped,
    required this.nastavniciMapped,
    required this.grupe,
    required this.predmeti,
    super.key,
  });

  final RasporedType rasporedType;
  final TimeOfDay najraniji;
  final TimeOfDay najkasniji;
  final GrupaId? selectedGrupa;
  final NastavnikId? selectedNastavnik;
  final Ucionica? selectedUcionica;
  final Map<Ucionica, Map<Dan, List<Raspored>>> mappedByUcionica;
  final Map<NastavnikId, Map<Dan, List<Raspored>>> mappedByNastavnici;
  final Map<GrupaId, Map<Dan, List<Raspored>>> mappedByGrupe;
  final Map<GrupaId, Grupa> grupeMapped;
  final Map<PredmetId, Predmet> predmetiMapped;
  final Map<NastavnikId, Nastavnik> nastavniciMapped;
  final List<GrupaId> grupe;
  final List<PredmetId> predmeti;
  ...
  Widget build(BuildContext context) {
    return PdfPreview(
      ...
      build: (final format) => _generateReport(
          rasporedType,
          najraniji,
          najkasniji,
          selectedGrupa,
                              ...
                              pw.Stack(
                                children: [
                                  ...
                                  pw.Builder(builder: (context) {
                                    ...
                                    try {
                                      if (rasporedType == RasporedType.grupa) {
                                        for (var i = 0;
                                            i < predmeti.length;
                                            i++) {
                                          colorsMapped[predmeti[i]] = colors[i];
                                        }
                                      }
                                                  ...
                                                  return pw.Container(
                                                    ...
                                                    padding:
                                                        const pw.EdgeInsets.all(
                                                            3),
                                                    decoration: !raspored.termin.show!
                                                        ? null
                                                        : pw.BoxDecoration(
                                                            color: raspored
                                                                    .termin
                                                                  ...
                                                                  if (rasporedType ==
                                                                    ...
                                                                    pw.Container(
                                                                      ...
                                                                      decoration: pw.BoxDecoration(
                                                                          color: colorsMapped[raspored
                                                                              .grupaId],
                                                                          borderRadius:
                                                                              pw.BorderRadius.circular(2.5)),
                                                                    ),
                                                                  ],
                                                                  if (rasporedType ==
                                                                      RasporedType
