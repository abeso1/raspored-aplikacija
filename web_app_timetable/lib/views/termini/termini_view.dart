                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            value: terminiNotifier.terminiSort,
                            items: TerminiSort.values
                                .map(
                            ...
                            onChanged: (value) {
                              if (value != null) {
                                terminiNotifier.setTerminiSort(value);
                              }
                            },
                          ),
                        ),
        ...
        Consumer<TerminiNotifier>(
          builder: (context, terminiNotifier, child) {
            ...
            if (terminiNotifier.termini.isEmpty &&
                !terminiNotifier.terminiFiltered) {
              return Row(
            ...
            return Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: terminiNotifier.termini
                      .map((termin) => Container(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  daniMappedNaBosanski[termin.dan]!,
                                  style: const TextStyle(
                                    fontSize: 16,
